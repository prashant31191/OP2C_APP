...
//	public static void yf25_register() {
//		Log.e("yf25_register");
...
//		
//		
////		lc.setVideoPort(30008);
////		lc.setAudioPort(30006);
//		
//		Log.e("firewall0 = " + LinphoneManager.getLc().isVideoSupported() + " " + LinphoneManager.getLc().isVideoEnabled());
//				
////		mNewPrefs.setEchoCancellation(false);
////		mNewPrefs.setNewAccountUsername("py71");
//		//TODO
////		mNewPrefs.setNewAccountUsername("0909111024");
////		mNewPrefs.setNewAccountPassword("12345678");
////		mNewPrefs.setNewAccountDomain("juiker.datamitetek.com");
//		
////		mNewPrefs.setNewAccountPassword("py6771");
////		mNewPrefs.setNewAccountDomain("sip.linphone.org");
////		mNewPrefs.setNewAccountOutboundProxyEnabled(true);
////		mNewPrefs.setNewAccountProxy("isip.dlinkddns.com:9090");
//		
//		Injector injector = Guice.createInjector(new Module());
//		AccountProvider account = injector.getInstance(AccountProvider.class);
//        Account acc = account.get();
//		mNewPrefs.setNewAccountUsername(acc.getUsername());
//		mNewPrefs.setNewAccountPassword(acc.getPassword());
//		mNewPrefs.setNewAccountUserId(acc.getUsername());
//		mNewPrefs.setNewAccountDomain(acc.getDomain());
////		mNewPrefs.setNewAccountProxy(acc.getDomain());
////		mNewPrefs.setStunServer("stun.linphone.org");
////		mNewPrefs.setTransport("tcp");
//		
//		
////		mNewPrefs.enableVideo(true);
////		mNewPrefs.setAutomaticallyAcceptVideoRequests(true);
////		mNewPrefs.setAutomaticallyShareMyVideo(true);
////		mNewPrefs.setInitiateVideoCall(true);
////		mNewPrefs.sendDtmfsAsRfc2833(true);
////		mNewPrefs.setBackgroundModeEnabled(false);
//		
////		 //mNewPrefs.setSipPort(5060);
////		mNewPrefs.setNewAccountExpires("604800");
////		mNewPrefs.setStunServer("stun.linphone.org");
//		
//		try {
////			mNewPrefs.setEchoCancellation(true);
...
//			mNewPrefs.setEchoCancellation(false);
//			
//////			mNewPrefs.setTransport("UDP");
//////			mNewPrefs.useRandomPort(false, true);
////			
////			mNewPrefs.enableVideo(true);
////			mNewPrefs.setAutomaticallyAcceptVideoRequests(false);
//////			mNewPrefs.setAutomaticallyShareMyVideo(true);
////			mNewPrefs.setInitiateVideoCall(true);
////			mNewPrefs.setAccountEnabled(0, false);
////			mNewPrefs.enableVideo(true);
////			mNewPrefs.setDefaultAccount(0);
//			
...
////		lc.setFirewallPolicy(FirewallPolicy.NoFirewall);
//////		lc.muteMic(false);
////		lc.setVideoPolicy(true, true);
////		lc.enableIpv6(false);
////		lc.setMediaEncryption(MediaEncryption.None);
//		
////		lc.setUploadBandwidth(0);
////		lc.setDownloadBandwidth(0);
//////		lc.setDefaultProxyConfig(arg0);
////		lc.setSipDscp(40);
////		lc.setAudioDscp(40);
////		lc.setVideoDscp(40);
//////		lc.setDefaultProxyConfig(mNewPrefs);//
...
////				android.util.Log.w("yf25", pt.getMime() + " <- mine");
////				lc.enablePayloadType(pt, true);
////			}
////		} catch (Exception e) {
////			e.printStackTrace();
